...
struct WindPlant <: RenewablePlant
    ...
    function WindPlant(;
        ...
        max_generation_mw::Float64 = installed_capacity_mw,
        ramp_up_mw_per_min::Float64 = 10.0,
        ramp_down_mw_per_min::Float64 = 10.0,
        curtailment_allowed::Bool = false,
        forced_outage_rate::Float64 = 0.0,
        is_dispatchable::Bool = false,
        commissioning_date::DateTime = DateTime(2020, 1, 1),
        num_turbines::Int = 1,
        must_run::Bool = true,
...
struct SolarPlant <: RenewablePlant
    ...
    function SolarPlant(;
        ...
        min_generation_mw::Float64 = 0.0,
        max_generation_mw::Float64 = installed_capacity_mw,
        ramp_up_mw_per_min::Float64 = 50.0,
        ramp_down_mw_per_min::Float64 = 50.0,
        curtailment_allowed::Bool = false,
        forced_outage_rate::Float64 = 0.0,
        is_dispatchable::Bool = false,
        commissioning_date::DateTime = DateTime(2020, 1, 1),
